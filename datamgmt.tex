...
\item Keeping track of versions
\item Data cleaning
  \ei
...
\begin{frame}[c]{Organizing data in spreadsheets}
  ...
  \item Be consistent.
  \item Use care about dates. (3 separate columns?)
  \item Put just one thing in a cell.
  \item Fill in all cells.
  \item No calculations in the raw data files.
...
\hfill
{\footnotesize \lolit
\href{https://kbroman.org/dataorg}{\tt kbroman.org/dataorg}
}
...
\begin{frame}[c]{2. Organize your data \& code}
